	...
	["AddInPacks"] = {
		...
		["GS-Papa"] = {
			...
			["SequenceNames"] = {
				...
				"Demo_aoe", -- [25]
				"Papa_Balance", -- [26]
				"WIP_WW_all_in_one", -- [27]
				"Papa_Enhance_beta", -- [28]
				"Frosty_heal", -- [29]
				"Shader_Aoe", -- [30]
				"Beaster_aoe", -- [31]
				"Veng", -- [32]
...
GSELibrary = {
	...
	}, -- [5]
	{
		...
		["PAPA_FROST_DK_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [combat] Remorseless Winter", -- [1]
					"/cast Frost Strike", -- [2]
					"/cast Frostscythe", -- [3]
					"/cast Frost Strike", -- [4]
					"/cast Frostscythe", -- [5]
					"/cast [combat] Remorseless Winter", -- [6]
					["LoopLimit"] = 5,
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
						"/cast [combat] Obliteration", -- [1]
						"/cast [combat] Pillar of Frost", -- [2]
						"/cast [combat] Anti-Magic Shell", -- [3]
						"/cast [mod:alt] Frostscythe", -- [4]
						"/cast [mod:ctrl] Howling Blast", -- [5]
						"/cast [mod:shift] Chains of Ice", -- [6]
					},
					["PostMacro"] = {
					},
					["PreMacro"] = {
						"/cast [combat] Howling Blast", -- [1]
					},
					["KeyRelease"] = {
					},
				}, -- [1]
		...
		["UNHOLY_GOD"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [@player] Defile", -- [1]
					"/castsequence Festering Strike, Festering Strike, Scourge Strike", -- [2]
					"/castsequence Festering Strike, Festering Strike, Scourge Strike, Apocalypse", -- [3]
					"/castsequence  reset=1  Scourge Strike", -- [4]
					"/cast [combat] Summon Gargoyle", -- [5]
					"/cast Death Coil", -- [6]
					"/cast [combat] Dark Transformation", -- [7]
					"/cast [@player] Defile", -- [8]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
						"/castsequence  reset=target/combat  Outbreak, null", -- [1]
						"/cast [mod:alt] Outbreak", -- [2]
						"/cast [nopet,nodead] Raise Dead", -- [3]
					},
					["PostMacro"] = {
					},
					["PreMacro"] = {
						"/cast Dark Transformation", -- [1]
					},
					["KeyRelease"] = {
					},
				}, -- [1]
	...
	}, -- [9]
	{
		["BREW"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence  reset=2  Keg Smash, Breath of Fire", -- [1]
					"/cast Blackout Strike", -- [2]
					"/cast Chi Wave", -- [3]
					"/castsequence  reset=1  Purifying Brew", -- [4]
					"/castsequence  reset=6  Ironskin Brew", -- [5]
					["Combat"] = true,
					["StepFunction"] = "Priority",
					["KeyRelease"] = {
					},
		...
		["WIP_WW_ALL_IN_ONE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence  reset=1  Tiger Palm, Tiger Palm, Tiger Palm", -- [1]
					"/castsequence  reset=1  Blackout Kick", -- [2]
					"/castsequence  reset=1  Rising Sun Kick", -- [3]
					"/castsequence [nochanneling] Fists of Fury", -- [4]
					["PostMacro"] = {
					},
					["StepFunction"] = "Priority",
					["KeyRelease"] = {
	...
	}, -- [11]
	{
		...
		["HAVOC_RUSH_BETA"] = {
			...
			["MacroVersions"] = {
				{
					"/cast [combat] Fury of the Illidari", -- [1]
					"/cast Chaos Strike", -- [2]
					"/cast [combat] Blade Dance", -- [3]
					"/castsequence Demon's Bite, Demon's Bite", -- [4]
					"/cast Throw Glaive", -- [5]
					"/cast Chaos Strike", -- [6]
					"/cast [combat] Blade Dance", -- [7]
					"/cast [nochanneling] Eye Beam", -- [8]
					"/castsequence Fel Rush, Vengeful Retreat", -- [9]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyRelease"] = {
					},
					...
					["KeyPress"] = {
						"/cast [mod:alt,nochanneling] Eye Beam", -- [1]
						"/cast [mod:ctrl,@player] Metamorphosis", -- [2]
						"/cast [mod:shift] Chaos Strike", -- [3]
						"/cast Nemesis", -- [4]
						"/cast Blur", -- [5]
					},
				}, -- [1]
		...
		["VENG"] = {
			...
			["MacroVersions"] = {
				{
					"/cast Immolation Aura", -- [1]
					"/cast Shear", -- [2]
					"/cast Felblade", -- [3]
					"/cast Soul Carver", -- [4]
					"/cast Soul Cleave", -- [5]
					"/cast [@player] Sigil of Flame", -- [6]
					"/cast [@player] Infernal Strike", -- [7]
					"/cast Throw Glaive", -- [8]
					["LoopLimit"] = 7,
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					...
					["KeyPress"] = {
						"/cast [mod:ctrl] Metamorphosis", -- [1]
						"/cast [mod:alt] Fiery Brand", -- [2]
						"/cast [mod:shift] Felblade", -- [3]
						"/castsequence  reset=target/combat  Throw Glaive, nul", -- [4]
						"/cast Empower Wards", -- [5]
					},
				}, -- [1]
			},
			["SpecID"] = 581,
