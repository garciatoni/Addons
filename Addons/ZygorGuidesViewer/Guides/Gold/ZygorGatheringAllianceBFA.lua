...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Frenzied Fangtooth",{
	meta={goldtype="route",skillreq={kul_tiran_fishing=1},levelreq=35},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Monelite Ore",{
	...
	meta={goldtype="route",skillreq={kul_tiran_mining=1},levelreq=35},
	items={{152512,240}},
	maps={"Stormsong Valley"},
	startlevel=35.0,
	},[[
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Coarse Leather",{
	meta={goldtype="route",skillreq={kul_tiran_skinning=1},levelreq=35},
	items={{152541,200}},
	maps={"Stormsong Valley"},
	},[[
	step
