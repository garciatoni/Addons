...
ZygorGuidesViewer:RegisterInclude("Choose_Foothold_1",[[
	...
	step
		Tiragarde Sound |condition havequest(51800) and not completedq(51984) |or |next "Tiragarde_Sound_Foothold_1"
		Drustvar |condition havequest(51801) and not completedq(51985) |or |next "Drustvar_Foothold_1"
		Stormsong Valley |condition havequest(51802) and not completedq(51986) |or |next "Stormsong_Valley_Foothold_1"
...
ZygorGuidesViewer:RegisterInclude("Choose_Foothold_2",[[
	...
	step
		Tiragarde Sound |condition havequest(51800) and not completedq(51984) |or |next "Tiragarde_Sound_Foothold_2" |only if not completedq(51984)
		Drustvar |condition havequest(51801) and not completedq(51985) |or |next "Drustvar_Foothold_2" |only if not completedq(51985)
		Stormsong Valley |condition havequest(51802) and not completedq(51986) |or |next "Stormsong_Valley_Foothold_2" |only if not completedq(51986)
...
ZygorGuidesViewer:RegisterInclude("Choose_Foothold_3",[[
	...
	step
		Tiragarde Sound |condition havequest(51800) and not completedq(51984) |or |next "Tiragarde_Sound_Foothold_3" |only if not completedq(51984)
		Drustvar |condition havequest(51801) and not completedq(51985) |or |next "Drustvar_Foothold_3" |only if not completedq(51985)
		Stormsong Valley |condition havequest(51802) and not completedq(51986) |or |next "Stormsong_Valley_Foothold_3" |only if not completedq(51986)
]])
