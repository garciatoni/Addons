...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Draenor Intro",{
next="Leveling Guides\\Draenor (10-50)\\Shadowmoon Valley (10-50)",
...
accept The Dark Portal##34398 |goto Blasted Lands/0 54.93,50.41 |or
step
talk Archmage Khadgar##78558
Tell him _"FOR AZEROTH!"_
Speak with Archmage Khadgar |q 36881/1 |goto 54.93,50.41 |only if havequest(36881) or completedq(36881)
Speak with Archmage Khadgar |q 34398/1 |goto 54.93,50.41 |only if havequest(34398) or completedq(34398)
step
talk Archmage Khadgar##78558
turnin The Dark Portal##36881 |goto Assault on the Dark Portal/0 54.72,48.26 |only if havequest(36881) or completedq(36881)
turnin The Dark Portal##34398 |goto Assault on the Dark Portal/0 54.72,48.26 |only if havequest(34398) or completedq(34398)
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Shadowmoon Valley (10-50)",{
next="Leveling Guides\\Draenor (10-50)\\Gorgrond (15-50)",
...
|only if havequest(34504) and level < 50
step
...
accept Delvar Ironfist##36633 |goto 48.00,30.63 |instant
step
...
|only if itemcount(115507) > 0 or havequest(36408)
step
...
|only if itemcount(115278) > 0 or havequest(36286)
step
talk Goggles##84825
...
|only if havequest(36286) or completedq(36286)
step
...
|only if havequest(36287) or completedq(36287)
step
talk Goggles##84825
...
|only if itemcount(113103) > 0 or havequest(35342)
step
talk Aenir##82466
...
|only if havequest(35342) or completedq(35342)
step
talk Abatha##82497
...
|only if itemcount(115343) > 0 or havequest(36309)
step
talk Haephest##80827
...
|only if havequest(36309) or completedq(36309)
step
talk Duna##85083
Tell him _"Yes, come with me."_
Find Duna |q 36311/1 |goto 51.09,36.93
|only if havequest(36311) or completedq(36311)
step
talk Haephest##80827
...
|only if itemcount(114984) > 0 or havequest(36239)
step
talk Sha'la##84724
...
|only if havequest(36241) or completedq(36241)
step
use the Dirty Note##114877
accept A Call for Huntsman##36176
|only if itemcount(114877) > 0 or havequest(36176)
step
talk Fanara##84385
...
|only if havequest(36176) or completedq(36176)
...
|only if havequest(36177) or completedq(36177)
step
...
|only if havequest(36185) or completedq(36185)
step
use the Cryptic Tome of Tailoring##114972
accept The Cryptic Tome of Tailoring##36236
|only if itemcount(114972) > 0 or havequest(36236)
step
talk Aerun##84776
...
|only if havequest(36236) or completedq(36236)
step
talk Ameeka##84523
...
|only if havequest(36262) or completedq(36262)
step
...
|only if havequest(36266) or completedq(36266)
step
talk Ameeka##84523
...
|only if havequest(36269) or completedq(36269)
step
talk Ameeka##84523
...
|only if itemcount(115281) > 0 or havequest(36308)
step
...
|only if havequest(36308) or completedq(36308)
step
...
|only if havequest(36315) or completedq(36315)
step
talk Arcanist Delath##84966
...
|only if havequest(36100) or completedq(36100)
step
#include "Garrison_BAlexston"
...
|only if havequest(34496) or completedq(34496)
step
...
|only if havequest(34076) or completedq(34076)
step
...
accept Fiona##35617 |goto 53.60,57.28 |instant
step
talk Beezil Linkspanner##80761
...
|only if havequest(34728) or completedq(34728)
step
...
accept Rulkan##35631 |goto 45.85,25.58 |instant
...
accept Shelly Hamby##35625 |goto 36.39,19.26 |instant
step
...
click Shrouding Stone##227272
Destroy the Northern Shrouding Stone |q 33115/2 |goto 2.66,30.71
step
...
|only if (not havequest(33533) or completedq(33533)) or (not havequest(36632) or completedq(36632)) or (not havequest(49564) or completedq(49564))
]])
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Gorgrond (15-50)",{
next="Leveling Guides\\Draenor (10-50)\\Talador (20-50)",
conditionsuggested=function() return level >= 15 and level <= 50 and not completedq(33269) end,
...
Begin Flying to Wildwood Wash |ontaxi |c |q 33533 |only if havequest(33533) or completedq(33533)
Begin Flying to Wildwood Wash |ontaxi |c |q 35556 |only if havequest(35556) or completedq(35556)
Begin Flying to Wildwood Wash |ontaxi |c |q 36632 |only if havequest(36632) or completedq(36632)
Begin Flying to Wildwood Wash |ontaxi |c |q 49564 |only if havequest(49564) or completedq(49564)
step
Fly to Wildwood Wash |offtaxi |goto Gorgrond/0 64.10,57.50 |q 33533 |notravel |only if havequest(33533) or completedq(33533)
Fly to Wildwood Wash |offtaxi |goto Gorgrond/0 64.10,57.50 |q 35556 |notravel |only if havequest(35556) or completedq(35556)
Fly to Wildwood Wash |offtaxi |goto Gorgrond/0 64.10,57.50 |q 36632 |notravel |only if havequest(36632) or completedq(36632)
Fly to Wildwood Wash |offtaxi |goto Gorgrond/0 64.10,57.50 |q 49564 |notravel |only if havequest(49564) or completedq(49564)
step
talk Yrel##80978
turnin The Secrets of Gorgrond##33533 |goto 63.99,57.20 |only if havequest(33533) or completedq(33533)
turnin The Secrets of Gorgrond##35556 |goto 63.99,57.20 |only if havequest(35556) or completedq(35556)
turnin The Secrets of Gorgrond##36632 |goto 63.99,57.20 |only if havequest(36632) or completedq(36632)
turnin Hero's Call: Gorgrond!##49564 |goto 63.99,57.20 |only if havequest(49564) or completedq(49564)
...
|only if havequest(36571) or completedq(36571)
step
...
|only if havequest(36563) or completedq(36563)
step
...
step
talk Glirin##85119
accept Lumber, I Hardly Knew 'Er##36828 |goto 53.02,59.81 |instant
step
...
|tip Inside the cave.
|only if havequest(34724) or completedq(34724)
step
...
|tip Inside the building.
|only if havequest(35881) or completedq(35881)
step
...
|tip Inside the cave.
|only if havequest(36520) or completedq(36520)
step
...
accept Service of Rangari Kaalya##35262 |goto 47.78,93.27 |instant
step
...
|only if havequest(36566) or completedq(36566)
step
...
|only if havequest(36473) or completedq(36473)
step
label "Slay_Monsters"
Kill enemies around this area
...
|only if havequest(36603) or completedq(36603)
step
...
|only if havequest(36476) or completedq(36476)
step
...
|only if havequest(36480) or completedq(36480)
step
...
accept The Fists of Vaandaam##35883 |goto 42.75,63.01 |instant
...
turnin Proof of Strength: Gronn Eye##36081 |goto 52.84,59.87 |only if havequest(36081) or completedq(36081)
step
talk Rangari Erdanii##85278
accept May I Be of Service?##36833 |goto 53.31,59.73 |instant
step
accept Bonus Objective: Mistcreep Mire##36563 |goto 52.11,66.69
|tip You will accept this quest automatically.
|only if level < 50
...
|tip Inside the tree.
|only if havequest(36500) or completedq(36500)
step
...
|only if havequest(36564) or completedq(36564)
step
...
|only if havequest(36504) or completedq(36504)
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Talador (20-50)",{
next="Leveling Guides\\Draenor (10-50)\\Spires of Arak (30-50)",
...
Take a Flight to Talador |ontaxi |q 37183 |only if havequest(37183) or completedq(37183)
Take a Flight to Talador |ontaxi |q 34676 |only if havequest(34676) or completedq(34676)
Take a Flight to Talador |ontaxi |q 49565 |only if havequest(49565) or completedq(49565)
|only if havequest(37183) or havequest(34676) or havequest(49565)
step
Fly to Talador |offtaxi |goto Talador/0 68.28,20.57 |q 37183 |notravel |only if havequest(37183) or completedq(37183)
Fly to Talador |offtaxi |goto Talador/0 68.28,20.57 |q 34676 |notravel |only if havequest(34676) or completedq(34676)
Fly to Talador |offtaxi |goto Talador/0 68.28,20.57 |q 49565 |notravel |only if havequest(49565) or completedq(49565)
|only if havequest(37183) or havequest(34676) or havequest(49565)
step
talk Foreman Eksos##79133
turnin The Critical Path##34676 |goto 69.88,20.81 |only if havequest(34676) or completedq(34676)
turnin The Critical Path##37183 |goto 69.88,20.81 |only if havequest(37183) or completedq(37183)
turnin Hero's Call: Talador!##49565 |goto 69.88,20.81 |only if havequest(49565) or completedq(49565)
...
|only if havequest(35236) or completedq(35236)
step
...
accept The True Path##36519 |goto 57.42,51.11 |instant
step
talk Niaa##81077
...
accept Armor Up##34982 |goto 69.78,20.74 |instant
step
talk Kalaam##79573
...
|only if havequest(37422) or completedq(37422)
step
...
accept New Owner##35239 |goto 62.88,50.45 |instant
step
...
|only if havequest(34639) or completedq(34639)
step
...
|only if havequest(34660) or completedq(34660)
step
...
accept Together We Are Strong##36512 |goto 46.32,74.09 |instant
step
...
|only if havequest(34667) or completedq(34667)
step
...
|tip Inside the cave.
|only if havequest(37421) or completedq(37421)
step
label "Slay_Goren_AS"
Kill Glowgullet enemies around this area
...
accept Joining the Ranks##34993 |goto 69.74,20.78 |instant
step
talk Kalaam##79573
accept As the Smoke Rises##34685 |goto 69.45,21.46
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Spires of Arak (30-50)",{
next="Leveling Guides\\Draenor (10-50)\\Nagrand (35-50)",
...
step
#include "Garrison_BGrey"
turnin News from Spires of Arak##35554 |only if havequest(35554) or completedq(35554)
accept Arakkoa Exodus##34653
step
#include "Garrison_DLongdrink"
Tell him _"Please fly me to Spires of Arak."_
Take a Flight to Spires of Arak |ontaxi |q 34653 |only if havequest(34653) or havequest(34653)
Take a Flight to Spires of Arak |ontaxi |q 36951 |only if havequest(36951) or havequest(36951)
step
Fly to Spires of Arak |offtaxi |goto Spires of Arak/0 37.34,14.94 |q 34653 |notravel |only if havequest(34653) or havequest(34653)
Fly to Spires of Arak |offtaxi |goto Spires of Arak/0 37.34,14.94 |q 36951 |notravel |only if havequest(36951) or havequest(36951)
step
talk Azik##79539
turnin Arakkoa Exodus##36951 |goto 37.89,18.03 |only if havequest(36951) or completedq(36951)
turnin Arakkoa Exodus##34653 |goto 37.89,18.03 |only if havequest(34653) or completedq(34653)
...
|tip He walks around this area.
|only if havequest(36660) or completedq(36660)
step
...
|only if havequest(35649) or completedq(35649)
step
...
|only if havequest(36792) or completedq(36792)
step
...
accept For Old Times' Sake##36353 |goto 39.98,60.65 |instant
step
...
accept Kimzee Pinchwhistle##36062 |goto 61.59,72.85 |instant
step
talk Reshad##81770
|tip Inside the building.
...
step
talk Ikky##85320
accept Ikky##34898 |goto 46.20,45.70 |instant
step
...
[64.31,27.01]
[67.09,28.14]
|only if havequest(36590) or completedq(36590)
step
...
|next "Stoktron_Brewery_2"	|only if havequest(37327) or completedq(37327)
|next "Smugglers_Den_2"		|only if havequest(35699) or completedq(35699)
step
...
accept Standing United##37281 |goto 39.73,60.91 |instant
|next "Merge_2"
step
...
accept Talonpriest Ishaal##37141 |goto 46.51,46.81 |instant
step
talk Shadow-Sage Iskar##80153
accept News from Nagrand##36601 |goto 46.59,46.53
|next "Leveling Guides\\Draenor (10-50)\\Nagrand (35-50)"
]])
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Nagrand (35-50)",{
...
Take a Flight to Nagrand |ontaxi |q 37184 |only if havequest(37184) or havequest(37184)
Take a Flight to Nagrand |ontaxi |q 34674 |only if havequest(34674) or havequest(34674)
step
Fly to Nagrand |offtaxi |goto Nagrand D/0 91.04,72.06 |q 37184 |notravel |only if havequest(37184) or havequest(37184)
Fly to Nagrand |offtaxi |goto Nagrand D/0 91.04,72.06 |q 34674 |notravel |only if havequest(34674) or havequest(34674)
step
talk Lieutenant Balfor##79263
turnin Taking the Fight to Nagrand##37184 |goto 86.38,66.20 |or |only if havequest(37184) or completedq(37184)
turnin Taking the Fight to Nagrand##34674 |goto 86.38,66.20 |or |only if havequest(34674) or completedq(34674)
...
|only if havequest(35379) or completedq(35379)
step
label "Kill_Loup"
...
accept The Honor of a Blademaster##34747 |goto 64.25,59.55 |instant
step
...
Bring Warlord Garrosh Hellscream to Justice |scenariostage 7/24797 |goto 71.40,84.59 |q 35169
step
...
|only if havequest(37280) or completedq(37280)
step
...
|only if havequest(34723) or completedq(34723)
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Tanaan Jungle (40-50)",{
...
Shadowmoon Valley |condition achieved(9833,1) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Shadowmoon Valley (10-50)"
Gorgrond |confirm |condition achieved(9833,2) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Gorgrond (15-50)"
Talador |condition achieved(9833,3) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Talador (20-50)"
Spires of Arak |condition achieved(9833,4) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Spires of Arak (30-50)"
Nagrand |condition achieved(9833,5) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Nagrand (35-50)"
step
