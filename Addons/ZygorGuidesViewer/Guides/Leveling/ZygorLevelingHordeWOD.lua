...
next="Leveling Guides\\Draenor (10-50)\\Frostfire Ridge (10-50)",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Frostfire Ridge (10-50)",{
...
|only if itemcount(115287) > 0 or havequest(36314)
step
...
|only if havequest(36314) or completedq(36314)
step
...
|tip Inside the building.
|only if havequest(36352) or completedq(36352)
step
...
|only if havequest(36378) or completedq(36378)
step
...
|only if havequest(36380) or completedq(36380)
step
talk Gem Grinder Orolak##85106
|tip Inside the building.
...
|only if itemcount(116438) > 0 or havequest(36589)
step
...
|only if havequest(36594) or completedq(36594)
...
|only if havequest(36627) or completedq(36627)
step
talk Blixthraz Blastcharge##85882
...
|only if itemcount(112566) > 0 or havequest(35058)
step
...
|only if havequest(35058) or completedq(35058)
step
#include "Garrison_Flightmaster"
Fly to Stonefang Outpost, Frostfire Ridge |ontaxi |q 35103
|only if havequest(35103) or completedq(35103)
step
...
|only if havequest(35104) or completedq(35104)
step
talk Ang'kra##81210
|tip Inside the building.
...
|only if havequest(35106) or completedq(35106)
step
...
|only if itemcount(114965) > 0 or havequest(36205)
step
...
|tip He walks around this area.
|only if havequest(36230) or completedq(36230)
step
...
|only if havequest(36238) or completedq(36238)
step
use the Illegible Sootstained Notes##115593
accept Unintelligible Intelligence##36435
|only if itemcount(115593) > 0 or havequest(36435)
step
...
|tip Inside the building.
|only if havequest(36435) or completedq(36435)
step
...
|only if havequest(36457) or completedq(36457)
step
...
|only if havequest(36475) or completedq(36475)
step
talk Nicholaus Page##85440
...
|only if itemcount(116173) > 0 or havequest(36505)
step
...
|only if havequest(36505) or completedq(36505)
step
...
|only if havequest(36516) or completedq(36516)
step
...
|only if itemcount(114973) > 0 or havequest(36301)
step
...
|only if havequest(36301) or completedq(36301)
step
Follow the path down |goto Frostfire Ridge/1 20.32,38.74 < 15 |only if walking
Kill enemies around this area
collect 10 Damaged Hexweave##115590 |q 36417/1 |goto Frostfire Ridge/0 26.55,40.97
|only if havequest(36417) or completedq(36417)
step
Follow the path up |goto Frostfire Ridge/1 20.28,31.40 < 20 |only if walking
Follow the path up |goto Frostfire Ridge/0 19.73,58.97 < 10 |only if walking
Enter the building |goto Frostfire Ridge/0 20.38,60.64 < 7 |walk
...
|only if havequest(36419) or completedq(36419)
step
talk Trega##84689
|tip Inside the building.
...
|only if itemcount(115008) > 0 or havequest(36255)
step
...
|only if havequest(36255) or completedq(36255)
step
Leave Your Garrison |goto Frostwall/0 50.00,50.00 > 500 |noway |c
|tip Follow the road north.
|only if havequest(36256) or completedq(36256)
step
...
|only if havequest(36257) or completedq(36257)
step
...
|only if havequest(36260) or completedq(36260)
step
talk Arcanist Delath##84739
...
|only if havequest(37669) or completedq(37669)
step
#include "Garrison_Gazlowe"
...
accept Mulverick's Offer of Service##34732 |goto 30.76,41.46 |instant
step
talk Gol'kosh the Axe##76662
...
|only if havequest(34505) or completedq(34505)
step
...
accept The Dark Lady's Gift##35243 |goto 62.12,23.00 |instant
step
talk Lokra##72274
...
accept Defection of Gronnstalker Rokash##35341 |goto 59.45,31.80 |instant
step
talk Shadow Hunter Rala##78208
...
|tip Inside the cave.
|only if havequest(34501) or completedq(34501)
step
...
accept Oath of Shadow Hunter Rala##34731 |goto Frostfire Ridge/0 52.63,40.42 |instant
step
...
|only if havequest(33145) or completedq(33145)
step
...
step
talk Durotan##74594
turnin The Secrets of Gorgrond##34867 |goto Gorgrond/0 37.28,77.01 |only if havequest(34867) or completedq(34867)
...
accept Kaz the Shrieker##35511 |goto 47.77,93.27 |instant
step
...
step
talk Penny Clobberbottom##85077
accept Penny For Your Thoughts##36812 |goto 46.36,69.65 |instant
step
talk Marrow##82732
...
step
talk Bruto##77014
accept The Interest of Bruto##35882 |goto 42.75,62.91 |instant
step
...
accept Get the Xuk Outta Here!##36832 |goto 44.11,48.82 |instant
...
Take a Flight to Talador |ontaxi |q 34681 |only if havequest(34681) or completedq(34681)
Take a Flight to Talador |ontaxi |q 36953 |only if havequest(36953) or completedq(36953)
Take a Flight to Talador |ontaxi |q 49547 |only if havequest(49547) or completedq(49547)
|only if havequest(34681) or havequest(36953) or havequest(49547)
step
Fly to Talador |offtaxi |goto Talador/0 71.98,28.26 |q 34681 |notravel |only if havequest(34681) or completedq(34681)
Fly to Talador |offtaxi |goto Talador/0 71.98,28.26 |q 36953 |notravel |only if havequest(36953) or completedq(36953)
Fly to Talador |offtaxi |goto Talador/0 71.98,28.26 |q 49547 |notravel |only if havequest(49547) or completedq(49547)
|only if havequest(34681) or havequest(36953) or havequest(49547)
step
...
|only if havequest(35237) or completedq(35237)
step
...
accept New Owner##35238 |goto 64.24,47.80 |instant
step
...
accept Joining the Ranks##34949 |goto 71.17,29.88 |instant
step
talk Knight-Lord Dranarus##79612
accept The Lady of Light##34696 |goto 71.84,29.75
step
...
accept Three Feet Under##36864 |goto 35.76,52.19 |instant
step
...
|next "Hearthfire_Tavern2"	|only if havequest(37326) or completedq(37326)
|next "Smugglers_Den_2"		|only if havequest(35697) or completedq(35697)
step
...
accept Standing United##37276 |goto 40.04,43.33 |instant
|next "Merge_2"
step
...
step
#include "Garrison_Rokhan"
turnin News from Nagrand##36602 |only if havequest(36602) or completedq(36602)
turnin News from Nagrand##36607 |only if havequest(36607) or completedq(36607)
accept Taking the Fight to Nagrand##34794
step
#include "Garrison_Flightmaster"
Tell him _"I need a flight to the border of Nagrand."_
Take a Flight to Nagrand |ontaxi |q 34794 |only if havequest(34794) or completedq(34794)
Take a Flight to Nagrand |ontaxi |q 36952 |only if havequest(36952) or completedq(36952)
step
Fly to Nagrand |offtaxi |goto Nagrand D/0 91.07,72.08 |notravel |only if havequest(34794) or completedq(34794)
Fly to Nagrand |offtaxi |goto Nagrand D/0 91.07,72.08 |notravel |only if havequest(36952) or havequest(36952)
step
talk Stone Guard Brox##80001
turnin Taking the Fight to Nagrand##34794 |goto 86.38,66.20 |only if havequest(34794) or completedq(34794)
turnin Taking the Fight to Nagrand##36952 |goto 86.38,66.20 |only if havequest(36952) or completedq(36952)
...
accept The Honor of a Blademaster##34770 |goto 82.59,46.74 |instant
step
...
Bring Warlord Garrosh Hellscream to Justice |scenariostage 7/24797 |goto 71.40,84.59 |q 35171
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Draenor (10-50)\\Tanaan Jungle (40)",{
...
Frostfire Ridge |condition achieved(9923,4) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Frostfire Ridge (10-50)"
Gorgrond |condition achieved(9923,5) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Gorgrond (15-50)"
Talador |condition achieved(9923,1) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Talador (20-50)"
Spires of Arak |condition achieved(9923,2) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Spires of Arak (30-50)"
Nagrand |condition achieved(9923,3) |confirm always |next "Leveling Guides\\Draenor (10-50)\\Nagrand (35-50)"
step
