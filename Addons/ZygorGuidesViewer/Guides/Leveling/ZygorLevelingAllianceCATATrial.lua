...
condition_suggested=function() return raceclass('Draenei') and level <= 5 and not completedq(9312) and not ZGV.InPhase("exilesreach") end,
condition_suggested_exclusive=true,
next="Leveling Guides\\Classic (1-50)\\Kalimdor\\Azuremyst Isle (1-50)",
startlevel=1,
endlevel=50
},[[
step
...
condition_suggested=function() return raceclass('Dwarf') and level <= 5 and not completedq(24493) and not ZGV.InPhase("exilesreach") end,
condition_suggested_exclusive=true,
next="Leveling Guides\\Classic (1-50)\\Eastern Kingdoms\\Dun Morogh (1-50)",
startlevel=1,
endlevel=50
},[[
step
...
condition_suggested=function() return raceclass('Gnome') and level <= 5 and not completedq(26364) and not ZGV.InPhase("exilesreach") end,
condition_suggested_exclusive=true,
next="Leveling Guides\\Classic (1-50)\\Eastern Kingdoms\\Dun Morogh (1-50)",
startlevel=1,
endlevel=5
...
condition_suggested=function() return raceclass('Human') and level <= 5 and not completedq(26390) and not ZGV.InPhase("exilesreach") end,
condition_suggested_exclusive=true,
next="Leveling Guides\\Classic (1-50)\\Eastern Kingdoms\\Elwynn Forest (1-50)",
startlevel=1,
endlevel=5
},[[
step
...
condition_suggested=function() return raceclass('NightElf') and level <= 5 and not completedq(14039) and not ZGV.InPhase("exilesreach") end,
condition_suggested_exclusive=true,
next="Leveling Guides\\Classic (1-50)\\Kalimdor\\Darkshore (5-50)",
startlevel=1,
endlevel=50
},[[
step
