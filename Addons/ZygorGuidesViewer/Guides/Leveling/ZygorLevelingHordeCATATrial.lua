...
next="Leveling Guides\\Classic (1-50)\\Eastern Kingdoms\\Eversong Woods (1-50)",
startlevel=1,
endlevel=5,
},[[
step
...
author="support@zygorguides.com",
image=ZGV.DIR.."\\Guides\\Images\\Death Knight 8-10",
condition_valid=function() return raceclass('DeathKnight') end,
condition_valid_msg="Death Knight only.",
condition_suggested=function() return (raceclass('Orc') or raceclass('Undead') or raceclass('Tauren') or raceclass('Troll') or raceclass('BloodElf') or raceclass('Goblin')) and raceclass('DeathKnight') and not completedq(13189) and level < 15 end,
condition_suggested_exclusive=true,
condition_end=function() return completedq(13189) end,
next="Leveling Guides\\Classic (1-50)\\Eastern Kingdoms\\Blasted Lands (15-50)",
startlevel=8,
endlevel=10,
},[[
step
...
next="Leveling Guides\\Classic (1-50)\\Kalimdor\\Northern Barrens (5-50)",
startlevel=1,
endlevel=10,
},[[
step
...
next="Leveling Guides\\Classic (1-50)\\Kalimdor\\Durotar (1-50)",
startlevel=1,
endlevel=5,
},[[
step
...
next="Leveling Guides\\Classic (1-50)\\Kalimdor\\Mulgore (1-50)",
startlevel=1,
endlevel=4,
},[[
step
...
next="Leveling Guides\\Classic (1-50)\\Eastern Kingdoms\\Silverpine Forest (5-50)",
startlevel=1,
endlevel=10,
},[[
step
