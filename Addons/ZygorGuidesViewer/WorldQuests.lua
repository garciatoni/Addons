...
local faction_data = {
	...
	[2422] = {quest=0, exp="sha", engname="The Wild Hunt", filepath=false},			-- The Wild Hunt            
	[2410] = {quest=0, exp="sha", engname="The Undying Army", filepath=false},			-- The Undying Army            
	[2407] = {quest=0, exp="sha", engname="The Ascended", filepath=false},			-- The Ascended
	[2413] = {quest=0, exp="sha", engname="Court of Harvesters", filepath=false},			-- Court of Harvesters
