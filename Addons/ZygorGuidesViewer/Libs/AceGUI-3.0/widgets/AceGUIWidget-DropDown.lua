...
do
	...
	local function ApplySkin(self)
		...
		CHAIN(normal)
			...
			:SetTexCoord(unpack(ZGV.ButtonSets.TitleButtons._DOWN.texcoords[1]))
		...
		CHAIN(pushed)
			...
			:SetPoint("LEFT",5,0)
			:SetTexture(ZGV.ButtonSets.TitleButtons.file)
			:SetTexCoord(unpack(ZGV.ButtonSets.TitleButtons._DOWN.texcoords[2]))
		...
		CHAIN(highlight)
			...
			:SetPoint("LEFT",5,0)
			:SetTexture(ZGV.ButtonSets.TitleButtons.file)
			:SetTexCoord(unpack(ZGV.ButtonSets.TitleButtons._DOWN.texcoords[3]))
		...
		CHAIN(disabled)
			...
			:SetPoint("LEFT",5,0)
			:SetTexture(ZGV.ButtonSets.TitleButtons.file)
			:SetTexCoord(unpack(ZGV.ButtonSets.TitleButtons._DOWN.texcoords[4]))
