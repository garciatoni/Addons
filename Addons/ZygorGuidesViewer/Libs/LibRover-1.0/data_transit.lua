...
---------------------
	...
	--## HORDE ##--
		...
		"Orgrimmar/1 57.47,92.31 -to- The Jade Forest/0 28.56,13.98 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
		...
		"Orgrimmar/1 57.11,87.34 -to- Shattrath City/0 53.01,49.21 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
		...
		"Orgrimmar/1 57.11,87.34 <override_text:You must be at least 10 to enter Outland.> <override_icon:error> -to- Shattrath City/0 53.01,49.21 "..
	...
	--## ALLIANCE ##--
		...
		"Stormwind City/0 45.72,87.11 -to- The Jade Forest/0 46.18,85.07 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
		...
		"Stormwind City/0 44.90,85.74 -to- Shattrath City/0 54.97,40.23 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10}"..
		...
		"Stormwind City/0 44.90,85.74 <override_text:You must be at least 10 to enter Outland.> <override_icon:error> -to- Shattrath City/0 54.97,40.23 "..
