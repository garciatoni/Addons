...
STYLE.RadioOn= {bgFile=SKINSDIR.."radiobutton-on", edgeFile=nil,tile = false, edgeSize=1, tileSize = 32, insets = { left = 0, right = 0, top = 0, bottom = 0 }}
STYLE.RadioOff={bgFile=SKINSDIR.."radiobutton-off",edgeFile=nil,tile = false, edgeSize=1, tileSize = 32, insets = { left = 0, right = 0, top = 0, bottom = 0 }}
