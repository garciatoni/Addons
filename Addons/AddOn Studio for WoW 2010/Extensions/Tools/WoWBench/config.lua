-- Config file for WoWBench.lua
-- use this file to further configure this WoWBench instance

_WOWDIR = "./wow"				-- The directory where WoW lives (needed for WTF and AddOns folders)
--_FRAMEXMLDIR = "./BlizzardToolkit/Interface/FrameXML"
--_EDITOR = "start notepad.exe"	-- Editor to use on e.g. editdump()
_LUAC = "luac.exe"		-- Lua compiler command
--_MINDELAY  = 0.2				-- Minimum delay enforced when entering blank lines (mostly useful in scripts)
